    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100, unique=True, verbose_name='Название вакансии')),
                ...
                ('shop', models.ManyToManyField(to='shop.shop', verbose_name='Адрес магазина')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ImageField(upload_to='image/user/', verbose_name='Картинка')),
